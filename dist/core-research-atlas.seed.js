window.CORE_RESEARCH_SEED = {
  ...
  "agentMessages": [
    {
      ...
      "content": "Agent console initialized. I can synthesize the local archive, active user profile, and queued extraction parameters. Live internet fetching requires a backend or connector."
    }
  ],
  "sourceSchema": {
    "required": [
  ...
  "sources": [
    {
      ...
      "notes": "Use as a baseline for literary and mythological transformation motifs. Extract animal-change structure, agency, reversibility, and moral framing.",
      "coreLinks": [
        "Core Manifestation Template",
        "Morphogenetic Field"
      ]
    ...
    },
    {
      ...
      "notes": "Used as an internal operational scaffold for prompt intake, profile merging, reference lookup, evidence separation, synthesis, extraction queueing, and export logging. It is not used as visual design.",
      "coreLinks": [
        "Core Manifestation Template",
        "Morphogenetic Field",
        "Physiological Hypothesis"
    ...
    },
    {
      ...
      "notes": "Background reference for practice vocabulary and experiential claims. Keep outputs profile-aware but preserve uncertainty labels for all transformation mechanics.",
      "coreLinks": [
        "Phantom / Mental Shift",
        "Core Manifestation Template",
        "Safety and Epistemic Notes"
  ...
  "internalModel": {
    ...
    "gateway": {
      ...
      "info": {
        ...
        "version": "1.0.0",
        "description": "Enables ChatGPT 5.5 Pro to orchestrate data flows and execute specialized backend actions."
      },
      "servers": [
        {
    ...
    "providerNote": "Uses a free local Ollama model through /api/local-agent when available, then optional OpenAI Responses API through /api/agent, then the local connector-ready profile fallback.",
    "synthesisScope": [
      "Archive sources",
  ...
  "externalApis": {
    ...
    "localWebScraper": {
      ...
      "safeguards": [
        "Blocks localhost/private/reserved IPs by default",
        "2 MB fetch cap",
