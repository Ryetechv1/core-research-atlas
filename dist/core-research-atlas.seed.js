window.CORE_RESEARCH_SEED = {
  "project": {
    ...
    "aiConnectorNote": "Separate AI assistant, retrieval console, and crawler surfaces have been removed. The atlas focuses on source logging, in-app browsing, imports, profiles, team collaboration, documents, and memory snapshots."
  },
  "categories": [
    "Documents",
    "Historical Data",
  ...
  "framework": [
    {
      ...
      "description": "Project vocabulary for the organizing blueprint behind identity, body schema, symbolic form, and proposed transformation mechanics."
    },
    {
      "name": "Morphogenetic Field",
      "description": "Use as a metaphysical or theoretical mapping layer. Scientific analogies should be separated from esoteric claims."
    },
    {
      "name": "Physiological Hypothesis",
      "description": "Tracks energy budget, tissue remodeling, neural integration, immune tolerance, and scaling constraints as speculative barriers."
    },
    {
      "name": "Phantom / Mental Shift",
      "description": "Separates body-schema experiences, phantom limbs, instincts, and identity states from physical transformation claims."
    },
    {
      "name": "Safety and Epistemic Notes",
      "description": "Flags unsupported claims, medical risk, source uncertainty, and areas requiring primary-source verification."
    }
  ],
  "profiles": [
    {
      ...
      "extended": [
        ...
        "Profile data may be used by the team source review context."
      ]
    },
    {
      "username": "UserSemaj",
      ...
      "extended": [
        ...
        "Profile data may guide fox and kitsune review priorities."
      ]
    },
    {
      ...
      "extended": [
        ...
        "Profile data may guide cross-form collaboration priorities."
      ]
    }
  ],
  "importedFiles": [],
  ...
  "sources": [
    {
      ...
      "notes": "Use as a baseline for literary and mythological transformation motifs. Review animal-change structure, agency, reversibility, and moral framing.",
      "coreLinks": [
        "Core Manifestation Template",
        "Morphogenetic Field"
      ]
    },
    {
      ...
      "notes": "Compare mental shifting claims with clinical descriptions without pathologizing spiritual identity by default.",
      "coreLinks": [
        "Phantom / Mental Shift",
    ...
    },
    {
      ...
      "notes": "Use as a grounded analogy for phantom tails, wings, ears, muzzle sensations, and non-ordinary body maps.",
      "coreLinks": [
        "Phantom / Mental Shift",
    ...
    },
    {
      ...
      "notes": "Track differences between possession, illusion, disguise, and physical transformation. Preserve transliteration variants.",
      "coreLinks": [
        "Core Manifestation Template",
        "Phantom / Mental Shift"
      ]
    },
    {
      ...
      "notes": "Define how the project will use this term. Distinguish invented taxonomy from historical terminology.",
      "coreLinks": [
        "Core Manifestation Template",
        "Safety and Epistemic Notes"
      ]
    },
    {
      ...
      "notes": "Separate dragon-as-serpent, dragon-as-deity, dragon-as-guardian, and human-dragon transformation cases by culture.",
      "coreLinks": [
        "Morphogenetic Field",
        "Core Manifestation Template"
      ]
    },
    {
      ...
      "notes": "Log trial texts, pamphlets, confessions, and legal context separately. Flag coercion and demonological framing.",
      "coreLinks": [
        "Safety and Epistemic Notes",
        "Core Manifestation Template"
      ]
    },
    {
      ...
      "notes": "Catalog claims as practices or testimonies, not verified mechanisms. Track ritual context and source lineage.",
      "coreLinks": [
        "Morphogenetic Field",
        "Phantom / Mental Shift"
      ]
    },
    {
      ...
      "notes": "Use only as analogy for form generation and tissue patterning. Do not imply macro-scale human-animal transformation is biologically demonstrated.",
      "coreLinks": [
        "Physiological Hypothesis",
        "Morphogenetic Field"
      ]
    ...
    },
    {
      ...
      "notes": "Capture vocabulary respectfully. Separate lived identity terms from historical lycanthropy and occult spellwork.",
      "coreLinks": [
        "Phantom / Mental Shift",
        "Core Manifestation Template"
      ]
    },
    {
      ...
      "notes": "Store as a named metaphysical system. Require source lineage, author attribution, and terminology normalization.",
      "coreLinks": [
        "Core Manifestation Template",
        "Morphogenetic Field"
      ]
    },
    {
      ...
      "notes": "Uploaded 16-page source summary used as a background map for wolf-focused shapeshifting concepts and source discovery. Treat as a guide requiring primary-source follow-up.",
      "coreLinks": [
        "Core Manifestation Template",
        "Phantom / Mental Shift",
        "Safety and Epistemic Notes"
    ...
    },
    {
      ...
      "notes": "Uploaded occult reference retained as metadata and high-level source lead only. Avoid embedding long excerpts; verify bibliographic provenance before quoting or redistributing.",
      "coreLinks": [
        "Morphogenetic Field",
        "Phantom / Mental Shift",
        "Safety and Epistemic Notes"
    ...
    },
    {
      ...
      "notes": "Used as an internal operational scaffold for prompt intake, profile merging, reference lookup, evidence separation, synthesis, source review and export logging. It is not used as visual design.",
      "coreLinks": [
        "Core Manifestation Template",
        "Morphogenetic Field",
        "Physiological Hypothesis"
    ...
    },
    {
      ...
      "notes": "Background reference for practice vocabulary and experiential claims. Keep review notes profile-aware while preserving uncertainty labels for all transformation mechanics.",
      "coreLinks": [
        "Phantom / Mental Shift",
        "Core Manifestation Template",
        "Safety and Epistemic Notes"
  ...
  "backendCore": {
    ...
    "summary": "Internal routing and synthesis scaffold derived from the ErydirCeisiwr attachment request. It controls how prompts, profiles, source records, source records, browser leads, documents, and exports are staged inside the static build.",
    "operatingMode": "Local static archive with source logging, imports, in-app browsing, team chat, documents, profiles, and memory bank.",
    "stages": [
      "Intent intake",
  ...
  "referenceLibrary": [
    {
      ...
      "handling": "Metadata and short descriptive summaries only; do not embed long copyrighted or unverified source text in the app.",
      "detectedTerms": [
        "wolf",
        "energy",
        "ritual",
  ...
  "externalApis": {
    "googleProgrammableSearch": {
      ...
      "scriptUrl": "https://cse.google.com/cse.js?cx=56f7592d1993141c3",
      "publicUrl": "https://cse.google.com/cse?cx=56f7592d1993141c3#gsc.tab=0",
      "elements": [
        "gcse-searchbox",
        "gcse-searchresults"
      ],
